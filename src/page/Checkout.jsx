...
import { Shield, Lock, Truck, CreditCard, MapPin, User, Phone, Mail, ArrowLeft, ShoppingBag, AlertCircle } from 'lucide-react';
...
const handlePaymentSubmit = (e) => {
    ...
    const order = {
      ...
      contact: { email: billingAddress.email, phone: billingAddress.phone },
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.phone ? 'border-red-500 focus:ring-red-300' : 'border-gray-300'}`}
