...
const ShoesCategory = () => {
  ...
  <div 
    className={`bg-white/95 backdrop-blur-md border-b border-gray-200 z-40 transition-all duration-300 ${
      scrolled 
        ? 'fixed top-0 left-0 right-0 shadow-lg animate-slideDown lg:sticky' 
        : 'sticky'
    }`} 
    style={{ top: scrolled ? '0px' : (headerHeight ? `${headerHeight}px` : undefined) }}
  >
