                        ...
                        <div className="relative mb-2 sm:mb-3 md:mb-4">
                          <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden">
                            <img
                              src={product.image}
                              alt={product.name}
                              onClick={() => navigate('/produit', { state: { productId: product.sourceId, productGender: product.gender } })}
                        ...
                        <div className="space-y-2 sm:space-y-3">
                          <div>
                            <h3 className="font-semibold text-gray-900 line-clamp-2 mb-1 text-xs sm:text-sm md:text-base">
                              <span onClick={() => navigate('/produit', { state: { productId: product.sourceId, productGender: product.gender } })} className="cursor-pointer">{getProductName(product)}</span>
                            </h3>
                          </div>
                          {/* Prix */}
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        onClick={() => {
                          ...
                          navigate('/produit', { state: { productId: quickViewProduct.sourceId, productGender: quickViewProduct.gender } })
                        }}
